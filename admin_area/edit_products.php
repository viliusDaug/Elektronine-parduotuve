...
<div class="container mt-5">
    ...
    <form action="" method="post" entype="multipart/form-data">
        <div class="form-ouline w-50 m-auto mb-4">
        ...
        <div class="form-ouline w-50 m-auto mb-4">
            ...
            <select name="product_brands" class="form-select">
                ...
                <?php
                    ...
                    $result_brands_all=mysqli_query($con, $select_brand_all);
...
<?php
   if(isset($_POST['edit_product'])){
    ...
    $temp_image1=$_POST['product_image1'];
    $temp_image2=$_POST['product_image2'];
    $temp_image3=$_POST['product_image3'];
